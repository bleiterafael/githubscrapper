...
namespace RBL.GitHub.Scrapper.API.Controllers
{
    ...
    [ApiController]
    public class ScrappingInfoController : MainController
    {

        private readonly IScrappingInfoService _scrappingService;
        public ScrappingInfoController(INotifier notifier,
            IScrappingInfoService scrappingService)
            : base(notifier)
        {
